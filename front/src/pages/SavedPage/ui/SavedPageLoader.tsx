...
export const SavedPageLoader = memo(() => {
  return (
    <div className="flex flex-col min-h-full">
      ...
      <div className="bg-light-l2 px-main py-main flex flex-col gap-4 grow">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="flex items-center gap-3 p-4 rounded-[var(--radius-xl)] bg-light-l3 shadow">
